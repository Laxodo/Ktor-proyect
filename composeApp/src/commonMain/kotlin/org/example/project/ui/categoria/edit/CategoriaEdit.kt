...
fun CategoriaEdit(
    ...
    val items by categoriaEditViewModel.items.collectAsState()
    ...
    Column(
        ...
        Row(
            ...
            OutlinedButton(
                onClick = {
                    //categoriaListViewModel.setSelectedCategoria(null)
                    onSelectItem(null);
        ...
        LazyVerticalGrid(
            ...
            items(filteredItems.size) { item ->
                CategoriaEditCard(filteredItems.get(item),{
                        onView(it)
                    },{
                        categoriaEditViewModel.delete(it)
                    }
                )
            }
        }
